...
; Function Attrs: norecurse ssp uwtable(sync)
...
2:                                                ; preds = %0, %2
  %3 = phi i32 [ 0, %0 ], [ %5, %2 ]
  %4 = tail call i32 @_Z4testv()
  %5 = add nuw nsw i32 %3, 1
  %6 = icmp eq i32 %5, 10
  br i1 %6, label %1, label %2, !llvm.loop !6
}

declare i32 @_Z4testv() local_unnamed_addr #1

attributes #0 = { norecurse ssp uwtable(sync) "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "probe-stack"="__chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" }
